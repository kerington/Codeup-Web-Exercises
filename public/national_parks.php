<?php
//connect to bd, and present db connection as $dbc variable
require __DIR__ . '/../db_connect.php'; 
require __DIR__ . '/../input.php';

//protect from looking at blank pages past the number of results. The number of results / limit to get number of total pages, round UP!
